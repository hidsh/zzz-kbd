...
マイコンにはファームウェアが書込まれているので、PC に接続するとHIDキーボードとして認識します。
...
左右の基板の裏面に 5mm スペーサーを取付けます。M2.6トラスネジを表面から差し込んで固定します。<br>
裏面とオモテ面を間違えないようにご注意ください。

![スペーサー取付け](./img/bg-spacer.jpg)

写真ではキースイッチがすでにハンダ付けされておりますが、先にスペーサを取り付けておいたほうが作業しやすいです。

## キースイッチのハンダ付け

MX スイッチと Choc スイッチをハンダ付けします。スタビライザーもこの時点で取付けておきます。
キースイッチ挿入後に真横からスイッチの位置を確認し、スイッチが浮いていないかを確認してからハンダ付けすることをおすすめします。

右基板の端にはスクロールセンサーがあります。ハンダ付け作業中にセンサーを曲げてしまわないようご注意ください。<br>
...
左右ケースにそれぞれ基板を差込んでねじで固定します。
写真は左ケースに左基板を取り付けるものですが、右ケースと右基板についても同様に行います。

下図の丸印の隙間に差し込むように、ケースの横から基板を入れます。
...
トラックボールケーブルをトラックボールユニットに接続します。トラックボールユニットをケースにはめたときに、ケーブルがケース内部に引っかからないように注意しておきます。
...
タッピングねじなので、初めてねじ止めするときはドライバーの先端方向に少し押す感じで締め始めます。<br>
...
[長くお使いいただくために](#長くお使いいただくために)には、ケースをバラすときの注意点やメンテナンスなど、今後役立つことを書きました。ぜひ、ご一読ください。
...
マウスと違い、トラックボールは光学式でも以下のようなメンテナンスが必要です。
...
他に40mmの球としては、卓球のボール、オルゴールボール、水晶玉が見つかりました。

ただし、水晶玉は直径40mmと記載があっても、実際は個体差によりかなり誤差があるようです。<br>
下の写真はAmazonで購入した透明の人工水晶玉です。透明のものでもトラックボールとしては動きますが、重量もあるので操球感は今ひとつでした。
